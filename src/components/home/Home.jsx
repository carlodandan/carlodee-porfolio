...
const Home = ({ onNavigate }) => {
  return (
    <section className="home-section min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto text-center">
        {/* Hero Section */}
        <div className="mb-12">
          <h1 className="home-title text-5xl sm:text-6xl lg:text-7xl font-bold text-gray-900 mb-6">
            Carlo Dee
          </h1>
          <p className="home-subtitle text-xl sm:text-2xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Anime-style Illustrator & Digital Artist
          </p>
          <p className="home-description text-lg text-gray-500 mb-12 max-w-3xl mx-auto">
            Bringing characters to life through vibrant colors, expressive emotions, 
            and the unique charm of anime-inspired artistry.
          </p>
          
          {/* CTA Buttons */}
          <div className="home-cta-container flex flex-col sm:flex-row gap-4 justify-center">
            <button
